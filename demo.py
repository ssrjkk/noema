...
print(f'Cyclomatic: {report.metrics.get("cyclomatic_complexity")}, Cognitive: {report.metrics.get("cognitive_complexity")}')
...
hcl = tg.generate_full_config('aws', {'vpc': {'cidr_block': '10.0.0.0/16'}, 'subnet': {'cidr_block': '10.0.1.0/24'}})
print('=== TERRAFORM HCL ===')
print(hcl[:400])
print()
...
dp.add_step(PipelineStep(name='transform', type='transform', config={'ops': ['filter', 'aggregate']}))
