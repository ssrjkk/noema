...
- [Руководство пользователя](docs/usage-guide.md) — полный справочник по CLI, API и библиотеке с примерами
...
Репозиторий проекта: [github.com/ssrjkk/noema](https://github.com/ssrjkk/noema)
