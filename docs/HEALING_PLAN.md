...
> Приоритизированный план лечения после аудита 2026-09-20. Все координаты file:line проверены эмпирически.
...
**Цель лечения:** Превратить Noema из демо-каркаса в работающую систему, которая делает то, что обещает README.

**Метод:** 4 приоритета (P0-P3), 22 задачи. P0 — критические, ломают продукт. P1 — безопасность. P2 — честность. P3 — качество.
